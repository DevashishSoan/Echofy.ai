/*
  # Enhanced profiles table and user management

  1. Changes
    - Drop trigger before dropping function to avoid dependency errors
    - Create enhanced function to handle new user profile creation with better error handling
    - Update RLS policies for better security and error handling
